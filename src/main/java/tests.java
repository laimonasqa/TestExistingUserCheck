...
public class tests {
  ...
  static Connection con = null;
	...
	public void readdatabase() throws Exception {
		...
		userName=String.valueOf(System.getProperty("user"));
		passCode=String.valueOf(System.getProperty("pwd"));
		//userName ="mrt393489733"; 
		//passCode = 	"111";	
		...
		/*if(url.contains("http://")){
		 ...
		 {
			 sPrefix = url.substring(0, url.indexOf('/')+2);
			 sSuffix = url.substring(url.indexOf('/')+2); 
			 url = sPrefix + sDemo +sSuffix;
		 }
...
/////////				l1test(ls.getString("testid"));
				try
				{
				existingUser(ls.getString("testid"), userName, passCode);
				}
					catch (Exception e){
...
public void ibnwithdrawl(String paymentcss,String logname) throws Exception{
						...
						if(wdmethod[j][1].equals("button")){
							...
							try{
								...
								if(paymentcss.toLowerCase().contains("paysafe")||paymentcss.toLowerCase().contains("ukash")){
									...
									try{
										Thread.sleep(200);
										driver.findElement(By.cssSelector("[name='withdrawalAmount']")).click();
										Thread.sleep(200);
	...
	public int paymenterrorcheck(String payment,int success) throws Exception{
		...
		System.out.println("-----------------------------------");
		String ct1,mb1,mb2,uk1,uk2,uke,nt1,nt2,nt3,nte,pp1,ps1,button,button2,vcno,vnoc,vvm,vvy,vcvv,qacvv,qavamount;
		...
		/*{
			...
			try{
				...
				//Thread.sleep(100);
				driver.findElement(By.name(vcno)).click();
				//Thread.sleep(100);
				driver.findElement(By.name(vcno)).clear();
				//Thread.sleep(100);
				driver.findElement(By.name(vcno)).sendKeys("4988243653999999");
				//Thread.sleep(100);
				driver.findElement(By.name(vnoc)).click();
				//Thread.sleep(100);
				driver.findElement(By.name(vnoc)).clear();
				//Thread.sleep(100);
				driver.findElement(By.name(vnoc)).sendKeys("Sean Randall");
				//Thread.sleep(100);
				//driver.findElement(By.name(vvm)).click();
				//Thread.sleep(100);
				new Select(driver.findElement(By.name(vvm))).selectByIndex(2);				
				//Thread.sleep(500);
				//driver.findElement(By.name(vvy)).click();
				//Thread.sleep(200);
				new Select(driver.findElement(By.name(vvy))).selectByIndex(2);				
				//Thread.sleep(500);
				driver.findElement(By.name(vcvv)).click();
				//Thread.sleep(100);
				driver.findElement(By.name(vcvv)).clear();
				//Thread.sleep(100);
				driver.findElement(By.name(vcvv)).sendKeys("287");
				String screenshot = "target/screenshots/VISA2" + timesta + ".png";
				takesc(screenshot);
				Thread.sleep(1000);
				result=result+"<p>Screenshot of VISA payment details <a href=../../"+screenshot+"><img SRC=../../"+screenshot+" width=100 height=100></a><p>";
				
				
				
			}catch(Exception e){
			
				result=result+"<p>Some Field Failed in VISA test<p>";
				System.out.println("Some field failed in VISA");
				success=1;
			...
			try{
				...
				while(!driver.getCurrentUrl().contains("visa")){
				...
				if(driver.getPageSource().contains("visa")){
					...
					System.out.println("VISA Communnication Confirmed");
					result=result+"<p>VISA Commuication Confirmed<p>";
					System.out.println("-----------------------------------");
					String screenshot = "target/screenshots/VISA1" + timesta + ".png";
					takesc(screenshot);
					Thread.sleep(1000);
					result=result+"<p>Screenshot of VISA payment suite <a href=../../"+screenshot+"><img SRC=../../"+screenshot+" width=100 height=100></a><p>";
					...
					try
					{
						driver.findElement(By.cssSelector(qacvv)).click();
						Thread.sleep(100);
						driver.findElement(By.cssSelector(qacvv)).clear();
						Thread.sleep(100);
						driver.findElement(By.cssSelector(qacvv)).sendKeys("287");
						
						driver.findElement(By.cssSelector(qavamount)).click();
						Thread.sleep(100);
						driver.findElement(By.cssSelector(qavamount)).clear();
						Thread.sleep(100);
						driver.findElement(By.cssSelector(qavamount)).sendKeys("20");
					}
					catch(Exception e){
					...
					while ( driver.getWindowHandles().size() == 1 ){	
					   ...
					   if ( ttimeCount > 50 ) 
					   {
						...
						String sscreenshot = "target/screenshots/VISA11" + timesta + ".png";
						takesc(sscreenshot);
						Thread.sleep(1000);
						result=result+"<p>Screenshot of VISA payment status <a href=../../"+sscreenshot+"><img SRC=../../"+sscreenshot+" width=100 height=100></a><p>";
					...
					result=result+"<p>VISA Commuication Failed<p>";
					//result2=result2+"<td>FAILED</td></tr>";
					success=1;
				...
				Thread.sleep(500);
				//driver.findElement(By.linkText("Change Payment Options")).click();
				//driver.navigate().back();
				driver.findElement(By.cssSelector("[qa='hpdeposit']")).click();
				//driver.close();
				Thread.sleep(500);
			...
			if(success==1){
				...
				System.out.println("VISA Commuication Failed");
				System.out.println("-----------------------------------");
				result=result+"<p>VISA Commuication Failed<p>";
				result2=result2+"<td>FAILED</td></tr>";
		...
		if(payment.equals("paysafe")){
			...
			try{
				Thread.sleep(200);
				driver.findElement(By.cssSelector(ps1)).click();
				Thread.sleep(200);
		...
		if(payment.equals("citadel")){
			...
			try{
				Thread.sleep(200);
				driver.findElement(By.cssSelector(ct1)).click();
				Thread.sleep(200);
		...
		if(payment.equals("skrill")){
			...
			try{
				System.out.println("Test Skrill --------------------------");
				Thread.sleep(100);
				driver.findElement(By.cssSelector(mb1)).click();
				Thread.sleep(200);
		...
		if(payment.equals("ukash")){
			...
			try{
				...
				Thread.sleep(100);
				driver.findElement(By.cssSelector(uk1)).click();
				Thread.sleep(200);
	...
	//			}finally{	
		...
		do{
			...
			try {
	    		...
	    		String genmail="srivalli.chavali@gtechg2.com";
	    		try{
	    		...
	    		driver.findElement(By.cssSelector(fname)).sendKeys("srivalli");
	    		}catch(Exception e){
	    			success=1;
	    		}
	    		...
	    		driver.findElement(By.cssSelector(lname)).sendKeys("chavali");
	    		}catch(Exception e){
	    			success=1;
	    		}
	    		//System.out.println("LName");
...
//	}
   ...
   public void existingUser(String testid, String userName, String passCode) throws Exception{
	   
	   boolean test =true;
	    overall="FAILED";
	    genlogin="userName: "+userName+" ,  Password: "+passCode;
		started=started+1;		
		System.out.println("-----------------------------------");
		System.out.println("IBN Existing User Test");
		System.out.println("-----------------------------------");
		
		
		String screenshot = "target/screenshots/screenshot1" + timesta + ".png";
		String fname,lname,email,day,month,year,next,eighteen,accept,login,password,repassword,fun,realbutton,screen;
		
		String button,button2, username, pwd, logout, logout1;
		int count=0;
				
		int success=0;
		int find=0;
		
		result=result+"<p><h3>IBN Existing User login verification: </h3>"+userName+"</p><p></p>";
		result=result+"<p>---------------------------------------------------</p><p></p>";
		WebDriverWait wait = new WebDriverWait(driver, 30);
		button="[qa='login']";
		button2="a#submit.btn";
		...
		try{
			System.out.println("Test Existing User --------------------------");
			//Thread.sleep(100);
			...
			//Thread.sleep(100);
			driver.findElement(By.name(pwd)).sendKeys(passCode);
			
			takesc(screenshot);
			Thread.sleep(1000);
			result=result+"<p>Screenshot of Existing User before login  <a href=../../"+screenshot+"><img SRC=../../"+screenshot+" width=100 height=100></a><p>";
			
			
			
		}catch(Exception e){
		
			result=result+"<p>Some Field Failed in ExistingUser test<p>";
			System.out.println("Some field failed in Existing user test");
			success=1;
		...
		test = false;
			...
			takesc(screenshot);
			Thread.sleep(1000);
			result=result+"<p>Screenshot of Invalid User <a href=../../"+screenshot+"><img SRC=../../"+screenshot+" width=100 height=100></a><p>";
			overall="FAILED";
			finished = 0;
			test = true;
		...
		if(driver.getCurrentUrl().contains("invalid") || test)
		{
			result=result+"<p>Some Field Failed in ExistingUser test<p>";
			System.out.println("Some field failed in Existing user test");
			success=1;
		...
		else
		{
			while ( driver.getWindowHandles().size() == 1 ){	
				...
				screenshot = "target/screenshots/screenshot2" + timesta + ".png";
				takesc(screenshot);
				Thread.sleep(1000);
				result=result+"<p>Screenshot of Existing User after login details <a href=../../"+screenshot+"><img SRC=../../"+screenshot+" width=100 height=100></a><p>";
				success=0;
...
//		}catch(Exception e){
//			driver.findElement(By.cssSelector(logout1)).click();
//		}
		
		try{
			
			wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(logout1)));				
		   }
		catch(Exception e)
		{
		...
		finished=finished+1;
		Thread.sleep(5000);
		screenshot = "target/screenshots/screenshot3" + timesta + ".png";
		takesc(screenshot);
		Thread.sleep(1000);
		result=result+"<p>Screenshot of Existing User log off <a href=../../"+screenshot+"><img SRC=../../"+screenshot+" width=100 height=100></a><p>";
		success=0;
		find =0;
		overall="PASSED";
		}
...
//	}
   ...
   public void existingUsertest(String logname,String email,String l2test) throws Exception{
